...
-- end::adocSQL[]
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Warlock (Infinity Gauntlet)', 'Adam Warlock',
        ...
        74);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Shazam (New 52)', 'Billy Batson',
        ...
        14);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Galadriel', '',
...
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Wonder Woman (DCEU)', 'Diana Prince',
        ...
        14);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Wong (MCU)', 'Wong',
...
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Shikamaru', 'Shikamaru Nara',
        ...
        11);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'John Hartigan', 'John Hartigan',
...
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Green Arrow (CW)', 'Oliver Queen',
        ...
        8);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Marvel Girl', 'Rachel Anne Summers',
        ...
        12);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Armor', 'Hisako Ichiki',
        'https://www.superherodb.com/pictures2/portraits/10/050/1347.jpg',
        'Energy Armor, Psionic Powers, Super Strength', 6);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Moon Knight', 'Marc Spector',
...
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Jack Kirby', 'Jack Kirby',
        'https://www.superherodb.com/pictures2/portraits/11/050/12580.jpg', 'Dexterity, Intelligence, Magic', 10);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Psylocke', 'Elizabeth Braddock',
        ...
        7);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Sherlock Holmes', 'Sherlock Holmes',
        ...
        10);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Genesis', 'Tyler Dayspring',
        ...
        8);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Doctor Strange (Modern)', 'Stephen Strange',
        ...
        65);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Toxin', 'Eddie Brock',
        ...
        10);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Anakin Skywalker', 'Anakin Skywalker',
...
VALUES (nextval('hibernate_sequence'), 'Michelangelo', '',
        ...
        6);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Buffy', 'Buffy Anne Summers',
        ...
        6);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Gandalf The White', 'Mithrandir',
        ...
        18);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Connor Hawke', 'Connor Hawke',
        ...
        7);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Bucky Barnes', 'James Buchanan Barnes',
        ...
        6);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Groot', 'Groot',
        ...
        11);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Moondragon', '',
        'https://www.superherodb.com/pictures2/portraits/11/050/414.jpg', '', 11);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'God Of Gods Shazam', 'Billy Batson',
        ...
        64);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Hawkeye (MCU)', 'Clint Barton',
...
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Danny Phantom', 'Daniel Fenton',
        ...
        15);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Spider-Man (Raimi Trilogy)', 'Peter Parker',
        ...
        6);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Shuri', 'Shuri',
        'https://www.superherodb.com/pictures2/portraits/11/050/12191.jpg',
        ...
        8);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Fat Thor (MCU)', 'Thor Odinson',
        ...
        15);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Songbird', 'Melissa Joan Gold',
...
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Black Canary', 'Laurel Lance',
...
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Arrow (CW)', 'Oliver Queen',
        ...
        3);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Jim Powell', 'Jim Powell',
        'https://www.superherodb.com/pictures2/portraits/10/050/1354.jpg', 'Durability, Jump, Super Strength', 4);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Cloak', 'Tyrone Johnson',
...
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Firestorm (CW)', 'Ronald Raymond',
        ...
        12);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Yo-yo (MCU)', 'Elena Rodriguez',
        ...
        7);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Wonder Woman (Smallville)', 'Diana Prince',
        ...
        15);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Groot (MCU)', 'Groot',
        'https://www.superherodb.com/pictures2/portraits/11/050/12501.jpg',
        'Biokinesis, Durability, Elasticity, Immortality, Light Control, Plant Control, Regeneration, Stamina, Super Speed, Super Strength',
        4);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Silver Surfer (FOX)', 'Norrin Radd',
        ...
        21);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Hulk (Worthy)', 'Bruce Banner',
...
VALUES (nextval('hibernate_sequence'), 'Gaea', '', 'https://www.superherodb.com/pictures2/portraits/11/050/327.jpg',
        ...
        50);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Lance Hunter (MCU)', 'Lance Hunter',
        ...
        6);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Monica Dawson', 'Monica Dawson',
        'https://www.superherodb.com/pictures2/portraits/10/050/942.jpg', 'Photographic Reflexes', 5);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Monkey D. Luffy', 'Luffy',
        'https://www.superherodb.com/pictures2/portraits/11/050/10936.jpg',
        ...
        7);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Clarisse La Rue', 'Clarisse La Rue',
        ...
        7);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Black Cat', 'Felicia Hardy',
...
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Katana (DCEU)', 'Tatsu Yamashiro',
        ...
        4);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Matt Parkman', 'Matthew Parkman',
        'https://www.superherodb.com/pictures2/portraits/10/050/948.jpg', 'Telepathy', 6);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Shadowcat', 'Kitty Pryde',
        ...
        8);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Nite Owl', 'Hollis Mason',
        'https://www.superherodb.com/pictures2/portraits/11/050/1060.jpg',
        ...
        6);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Ancient One', 'Yao',
        'https://www.superherodb.com/pictures2/portraits/11/050/11111.jpg',
        ...
        59);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Jesse Quick', 'Jesse Chambers',
        ...
        13);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Rachel Pirzad', '',
        ...
        5);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Polaris', 'Lorna Dane',
        ...
        8);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Jennifer Kale', 'Jennifer Kale',
        'https://www.superherodb.com/pictures2/portraits/10/050/1321.jpg', 'Force Fields, Magic, Portal Creation', 8);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'The Crow', 'Eric Draven',
        'https://www.superherodb.com/pictures2/portraits/11/050/11017.jpg',
        ...
        24);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Agent Coulson', 'Phillip Phil Coulson',
        'https://www.superherodb.com/pictures2/portraits/11/050/10299.jpg',
        'Intelligence, Weapon-based Powers, Weapons Master', 8);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Vampire Jubilee', 'Jubilation Lee',
        ...
        13);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Flash (CW)', 'Barry Allen',
        ...
        21);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Elastigirl', 'Helen Parr',
...
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Gamora (MCU)', 'Gamora',
        'https://www.superherodb.com/pictures2/portraits/11/050/12502.jpg',
        'Accelerated Healing, Agility, Enhanced Senses, Reflexes, Stamina, Super Speed, Super Strength, Weapons Master',
        3);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Ratchet', 'Ratchet',
        ...
        11);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Genji', 'Genji Shimada',
        'https://www.superherodb.com/pictures2/portraits/11/050/12719.jpg',
        ...
        8);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Iron Man (Sorceror Supreme)', 'Doctor Anthony Stark',
        ...
        59);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Green Lantern (Pre-Crisis)', 'Hal Jordan',
        ...
        47);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Colossus (FOX)', 'Peter Rasputin',
        ...
        6);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Spaceboy', 'Luther Hargreeves',
        ...
        7);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Civil Warrior', 'Steve Rogers',
        ...
        17);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Batgirl (New 52)', 'Barbara Gordon',
        ...
        9);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Jimmy Neutron', 'Jimmy Neutron',
        ...
        26);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Batgirl VI', 'Stephanie Brown',
        'https://www.superherodb.com/pictures2/portraits/10/050/1398.jpg',
        'Agility, Marksmanship, Stamina, Weapon-based Powers', 6);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Sasquatch', 'Walter Langkowski',
...
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Robin IV', 'Stephanie Brown',
...
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Ion', 'Sodam Yat',
        'https://www.superherodb.com/pictures2/portraits/11/050/13417.jpg',
        ...
        45);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Batman (Smallville)', 'Bruce Wayne',
        'https://www.superherodb.com/pictures2/portraits/11/050/14645.jpg',
        'Intelligence, Stealth, Weapon-based Powers, Weapons Master', 10);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Queen Hippolyta', 'Hippolyta',
...
VALUES (nextval('hibernate_sequence'), 'Orion', '', 'https://www.superherodb.com/pictures2/portraits/10/050/10485.jpg',
        ...
        40);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Mockingbird', 'Barbara Morse',
...
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Snowbird', 'Narya',
        ...
        5);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Jack of Hearts', 'Jonathan Hart',
        ...
        8);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Minato Namikaze', '',
        ...
        16);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Lightray', 'Solis',
        ...
        19);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Triplicate Girl', 'Luornu Durgo',
        'https://www.superherodb.com/pictures2/portraits/10/050/1185.jpg', 'Duplication, Flight', 6);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Hellboy (Columbia)', 'Anung Un Rama',
        ...
        7);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Triton', 'Triton',
        ...
        6);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Supergirl', 'Kara Zor-El',
        ...
        19);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Peggy Carter (MCU)', 'Margaret Carter',
        ...
        8);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Mace Windu', 'Mace Windu',
        ...
        19);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Mockingbird (MCU)', 'Barbara Morse',
...
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Psylocke (FOX)', 'Elizabeth Braddock',
...
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Blue Marvel', 'Adam Brashear',
        ...
        15);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Archangel', 'Warren Kenneth Worthington III',
...
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Penny', 'William Adiyodi',
        'https://www.superherodb.com/pictures2/portraits/11/050/12534.jpg',
        ...
        15);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Silk Spectre', 'Sally Juspeczyk',
        'https://www.superherodb.com/pictures2/portraits/11/050/1057.jpg', 'Peak Human Condition', 4);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Big Daddy', 'Damon Macready',
        'https://www.superherodb.com/pictures2/portraits/10/050/1338.jpg', 'Stamina', 3);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Gladiator Hulk', 'Robert Bruce Banner',
        ...
        18);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Luke Skywalker (Dark Empire)', 'Luke Skywalker',
        ...
        40);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Android 16', '',
        'https://www.superherodb.com/pictures2/portraits/11/050/1238.jpg',
        ...
        14);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Red She-Hulk', 'Betty Ross',
        ...
        9);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Silverclaw', 'Maria de Guadalupe Santiago',
...
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Aragorn', 'Aragorn II Elessar',
        ...
        7);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Ichigo Kurosaki', 'Ichigo Kurosaki',
        ...
        8);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Bantam', 'Roberto Velasquez',
        'https://www.superherodb.com/pictures2/portraits/10/050/229.jpg', 'Durability, Stamina, Super Strength', 3);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Yoda', 'Yoda',
        ...
        13);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Green Arrow (Injustice)', 'Oliver Queen',
...
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Baby Groot', 'Groot Dutch',
        ...
        5);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Thunderbird', 'John Proudstar',
        'https://www.superherodb.com/pictures2/portraits/10/050/611.jpg',
        'Durability, Stamina, Super Speed, Super Strength', 4);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Donna Troy', 'Donna Hinckley Stacey Troy',
        ...
        12);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Gipsy Danger', 'Gipsy Danger',
        ...
        13);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Captain Hindsight', 'Jack Brolin',
        'https://www.superherodb.com/pictures2/portraits/10/050/10399.jpg', 'Enhanced Senses, Flight, Super Speed', 3);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Grand Master Skywalker', 'Luke Skywalker',
        ...
        87);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Vishnu', 'Vishnu Narayana',
        ...
        78);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Jessica Jones', 'Jessica Campbell Jones Cage',
...
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Jack-Jack', 'Jack-Jack Parr',
        ...
        4);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Steel', 'John Irons',
...
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Future Trunks', 'Trunks',
        'https://www.superherodb.com/pictures2/portraits/11/050/15393.jpg',
        ...
        13);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Red Tornado', 'Lois Lane',
        'https://www.superherodb.com/pictures2/portraits/11/050/13432.jpg',
        ...
        19);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Nyssa Al Ghul (CW)', 'Nyssa Raatko',
        ...
        6);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Lloyd (The LEGO Ninjago Movie)', 'Lloyd Garmadon',
        ...
        7);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Sharon Carter', 'Sharon Carter',
        'https://www.superherodb.com/pictures2/portraits/11/050/123.jpg', 'Dexterity, Intelligence, Weapons Master', 9);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'World War Hulk', 'Bruce banner',
        ...
        16);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Legolas', 'Legolas Of Mirkwood',
        ...
        13);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Bishop (Fox)', 'Lucas Bishop',
...
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Katana', 'Tatsu Yamashiro',
...
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Absorbing Man (MCU)', 'Carl Creel',
        ...
        8);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), '3-D Man', 'Charles Chandler',
        'https://www.superherodb.com/pictures2/portraits/10/050/226.jpg',
        'Agility, Stamina, Super Speed, Super Strength', 4);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Domino', 'Neena Thurman',
        'https://www.superherodb.com/pictures2/portraits/10/050/902.jpg',
        'Agility, Marksmanship, Probability Manipulation, Reflexes', 5);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Quasar', 'Wendell Vaughn',
        'https://www.superherodb.com/pictures2/portraits/11/050/11697.jpg',
        ...
        12);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Jean Grey (FOX)', 'Jean Grey',
        'https://www.superherodb.com/pictures2/portraits/11/050/13889.jpg', 'Telekinesis, Telepathy', 6);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Geo-force', 'Brion Markov',
        ...
        13);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Gogeta', 'Goku/Vegeta',
        ...
        17);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Jean Grey', 'Jean Grey',
        ...
        11);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Alien X', 'Celestialsapien',
        ...
        28);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Korg (MCU)', 'Korg',
        'https://www.superherodb.com/pictures2/portraits/11/050/13764.jpg',
        ...
        6);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'SCP-343', 'God',
        'https://www.superherodb.com/pictures2/portraits/10/050/14709.jpg',
        ...
        181);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Hawkgirl', 'Kendra Saunders',
        ...
        7);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Volstagg (MCU)', 'Volstagg',
        ...
        6);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Mr Incredible', 'Robert Parr',
...
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Black Siren (CW)', 'Laurel Lance (Earth Two)',
...
VALUES (nextval('hibernate_sequence'), 'Wu', 'Wu', 'https://www.superherodb.com/pictures2/portraits/10/050/16047.jpg',
        ...
        18);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Bucky Barnes (MCU)', 'Bucky Barnes',
        ...
        3);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Black Bolt (MCU)', 'Blackagar Boltagon',
        ...
        7);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Makkari', 'Makkari',
        ...
        45);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Agent Bob', 'Bob',
        'https://www.superherodb.com/pictures2/portraits/10/050/10255.jpg', 'Stealth', 2);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Bling!', 'Roxanne Washington',
        'https://www.superherodb.com/pictures2/portraits/10/050/1349.jpg', 'Durability, Natural Armor, Natural Weapons',
        7);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Valkyrie', 'Brunnhilde',
        ...
        12);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Detective Chimp', 'Bobo T. Chimpanzee',
        ...
        12);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Arcee', 'Arcee',
        ...
        6);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Impulse II', 'Iris West',
        'https://www.superherodb.com/pictures2/portraits/11/050/10545.jpg',
        'Element Control, Speed Force, Super Speed, Teleportation', 6);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Captain Snowball', 'Snowball',
        'https://www.superherodb.com/pictures2/portraits/10/050/16720.jpg', 'Agility, Jump', 1);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Old King Thor', 'Thor Odinson',
        ...
        97);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Quicksilver (Fox)', 'Peter Maximoff',
...
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Zia Rashid', 'Zia Rashid',
        ...
        26);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'M.J.', 'Mary Jane Watson',
        'https://www.superherodb.com/pictures2/portraits/11/050/11483.jpg', 'Peak Human Condition', 3);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Maiev Shadowsong', '',
        'https://www.superherodb.com/pictures2/portraits/11/050/14740.jpg',
        ...
        15);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Vicki Vale', 'Vicki Vale',
        'https://www.superherodb.com/pictures2/portraits/11/050/11798.jpg', 'Intelligence', 5);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Green Lantern (Injustice)', 'Hal Jordan',
        ...
        13);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Mary Embrey', 'Mary Embrey',
        ...
        13);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Maverick', 'Christopher Bradley',
        'https://www.superherodb.com/pictures2/portraits/10/050/257.jpg', 'Electrokinesis', 6);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'The Lobster', 'Lobster Johnson',
        ...
        19);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Ultragirl', 'Tsu-Zana',
...
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'US Agent', '', 'https://www.superherodb.com/pictures2/portraits/11/050/521.jpg',
        '', 6);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Dazzler', 'Alison Blaire',
        ...
        9);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'King Kong', 'King Kong',
        ...
        11);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Namorita', 'Namorita Prentiss',
        ...
        6);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Mantis (MCU)', 'Mantis',
        'https://www.superherodb.com/pictures2/portraits/11/050/12592.jpg',
        'Durability, Empathy, Enhanced Senses, Enhanced Touch, Stamina', 5);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Saturn Girl (CW)', 'Imra Ardeen',
        ...
        7);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Claire Bennet', 'Claire Bennet',
        'https://www.superherodb.com/pictures2/portraits/10/050/941.jpg', 'Accelerated Healing, Regeneration', 6);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'World Breaker Hulk', 'Bruce Banner',
        ...
        37);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Hawkwoman', 'Shayera Thal',
...
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Jane Foster (MCU)', 'Jane Foster',
        'https://www.superherodb.com/pictures2/portraits/11/050/13883.jpg', 'Intelligence, Intuitive aptitude', 9);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Spider-Man 2099', 'Miguel Ohara',
        ...
        12);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Kelly Friday', 'Kelly Friday',
        'https://www.superherodb.com/pictures2/portraits/10/050/15972.jpg', '', 3);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Iron Man (Endosym Armor)', 'Tony Stark',
        ...
        27);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Polaris (Fox)', 'Lorna Dane',
        ...
        7);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Chi Chi', 'Chi-Chi',
        'https://www.superherodb.com/pictures2/portraits/11/050/1221.jpg',
        'Durability, Enhanced Senses, Stamina, Vision - Night, Weapons Master', 5);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Wolfsbane', 'Rahne Sinclair',
        ...
        4);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Avatar (The Last Airbender)', 'Aang',
        ...
        7);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Huntress', 'Helena Wayne',
        'https://www.superherodb.com/pictures2/portraits/11/050/12607.jpg',
        ...
        5);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Hellcat', 'Patricia Walker',
        ...
        6);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Cyclops', 'Scott Summers',
...
VALUES (nextval('hibernate_sequence'), 'Mary Marvel', 'Mary Willow Batson',
        ...
        23);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Devil Dinosaur', 'Devil',
        'https://www.superherodb.com/pictures2/portraits/11/050/10934.jpg',
        'Animal Attributes, Animal Oriented Powers, Separation, Super Strength, Telepathy', 9);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Colossus', 'Peter Rasputin',
        ...
        8);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Simba', 'Simba',
        ...
        9);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Fire', '', 'https://www.superherodb.com/pictures2/portraits/11/050/1380.jpg',
        'Element Control, Fire Control, Fire Resistance, Flight, Intangibility', 9);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Daredevil (MCU)', 'Matt Murdock',
        ...
        4);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Bird-Brain', '',
        'https://www.superherodb.com/pictures2/portraits/10/050/240.jpg', 'Animal Attributes, Flight, Natural Weapons',
        3);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Lois Lane', 'Lois Lane',
        'https://www.superherodb.com/pictures2/portraits/11/050/10513.jpg', 'Marksmanship', 3);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Mothman', 'Byron Lewis',
        ...
        9);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Gray Fullbuster', 'Gray Fullbuster',
        ...
        7);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Quill', 'Maxwell Jordan',
        'https://www.superherodb.com/pictures2/portraits/10/050/830.jpg', 'Substance Secretion, Weapon-based Powers',
        3);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Samurai Jack', 'Jack',
        'https://www.superherodb.com/pictures2/portraits/11/050/12390.jpg',
        ...
        16);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Superman (CW)', 'Kal-El',
        'https://www.superherodb.com/pictures2/portraits/11/050/15438.jpg',
        ...
        10);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Darkhawk', 'Christopher Powell',
        ...
        6);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Arno Victor Dorian', 'Arno Victor Dorian',
        ...
        9);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'The Prince', 'Dastan',
        ...
        10);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Sunspot', 'Roberto DaCosta',
        ...
        8);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Blake', 'Blake Belladonna',
        ...
        9);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Jazz', 'Jazz',
        ...
        9);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Arcee (TFP)', 'Arcee',
        ...
        7);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Emma Frost (FOX)', 'Emma Grace Frost',
...
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Hawkwoman III', 'Shayera Thal',
        'https://www.superherodb.com/pictures2/portraits/10/050/1130.jpg', 'Flight, Gliding, Super Strength', 6);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'One Punch Man', 'Saitama',
        ...
        10);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Finn', 'FN-2187',
        'https://www.superherodb.com/pictures2/portraits/11/050/10644.jpg',
        'Intelligence, Marksmanship, Peak Human Condition, Weapon-based Powers, Weapons Master', 8);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Batman (New 52)', 'Bruce Wayne',
...
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Kathryn Janeway', 'Kathryn Janeway',
        'https://www.superherodb.com/pictures2/portraits/10/050/10581.jpg', 'Intelligence', 6);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Master Chief', 'John-117',
        ...
        9);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Hawkman', 'Carter Hall',
        ...
        8);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Wiccan', 'Billy Kaplan',
        ...
        26);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Cable', 'Nathan Summers',
        ...
        21);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Luke Cage (MCU)', 'Luke Cage',
...
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Static', 'Virgil Hawkins',
        ...
        8);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Sonic The Hedgehog', 'Sonic',
        'https://www.superherodb.com/pictures2/portraits/10/050/10532.jpg',
        'Agility, Durability, Jump, Stamina, Super Speed', 6);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Harry Potter', 'Harry James Potter',
        ...
        15);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Koko (The LEGO Ninjago Movie)', 'Koko',
        ...
        7);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Lone Ranger', 'Johnathan Reid',
        ...
        5);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Scarlet Spider II', 'Kaine Parker',
        ...
        8);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Zane', 'Zane',
        'https://www.superherodb.com/pictures2/portraits/11/050/16124.jpg',
        ...
        22);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Vegeta (Dragon Ball GT)', 'Vegeta IV',
        ...
        17);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Hiruzen Sarutobi', '',
        ...
        13);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Vision', 'Vision',
        ...
        13);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Robocop', 'Alex Murphy',
        ...
        7);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'The Flash (DCEU)', 'Barry Allen',
        ...
        12);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Firestorm II (CW)', 'Jefferson Jackson',
        ...
        15);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Grover Underwood', 'Grover Underwood',
        ...
        12);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Atom II', 'Ray Palmer',
...
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Skaar', '', 'https://www.superherodb.com/pictures2/portraits/10/050/1341.jpg',
        'Accelerated Healing, Elemental Transmogrification, Jump, Stamina, Super Strength', 8);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Vegito', 'Vegeta/Goku',
        ...
        19);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Elaine Belloc (Angel)', 'Elaine Belloc',
        ...
        93);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Alfred Pennyworth', 'Alfred Thaddeus Crane Pennyworth',
...
VALUES (nextval('hibernate_sequence'), 'Fox', 'Fox McCloud',
        ...
        5);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Agent Venom', 'Flash Thompson',
        ...
        8);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Batman II', 'Dick Grayson',
        ...
        8);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Martian Manhunter (CW)', 'Jonn Jonzz',
        ...
        14);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Century', '', 'https://www.superherodb.com/pictures2/portraits/10/050/1511.jpg',
        'Dimensional Travel, Regeneration, Teleportation', 11);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Captain Marvel', 'Janet Van Dyne',
        ...
        22);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Thunderstrike', 'Eric Kevin Masterson',
...
VALUES (nextval('hibernate_sequence'), 'Ghost Rider II (MCU)', 'Robbie Reyes',
        ...
        16);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Sersi', 'Sersi',
        ...
        60);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Batwoman', 'Helena Wayne',
        'https://www.superherodb.com/pictures2/portraits/11/050/13806.jpg',
        'Dexterity, Marksmanship, Toxin and Disease Resistance, Weapons Master', 7);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Tsunade', '',
        ...
        15);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Spider-Man (SONY)', 'Peter Parker',
        ...
        6);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Cabba', 'Cabba',
        'https://www.superherodb.com/pictures2/portraits/11/050/15322.jpg',
        'Accelerated Healing, Durability, Energy Blasts, Flight, Intelligence, Power Augmentation, Super Speed, Super Strength',
        12);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'The Green Hornet', 'Britt Reid',
        ...
        6);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Asura', 'Asura',
        ...
        32);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Valkyrie (MCU)', 'Brunnhilde',
        ...
        14);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Beast Boy (Titans)', 'Garfield Logan',
        ...
        5);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Obi-Wan Kenobi', 'Obi-Wan Kenobi',
        ...
        22);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Vibe', 'Cisco Ramon',
...
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Annabeth Chase (FOX)', 'Annabeth Chase',
        'https://www.superherodb.com/pictures2/portraits/10/050/16126.jpg',
        'Intelligence, Weapon-based Powers, Weapons Master', 6);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Batman (Burtonverse)', 'Bruce Wayne',
...
VALUES (nextval('hibernate_sequence'), 'Vampire Batman', 'Bruce Wayne',
        ...
        22);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Spartan', 'John Diggle',
        'https://www.superherodb.com/pictures2/portraits/11/050/11173.jpg',
        ...
        6);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Weapon H', 'Clayton',
        'https://www.superherodb.com/pictures2/portraits/11/050/12442.jpg',
        'Accelerated Healing, Enhanced Senses, Invulnerability, Jump, Marksmanship, Regeneration, Super Speed, Super Strength',
        13);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Monarch', 'Nathaniel Christopher Adam',
        ...
        53);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Gambit', 'Remy Etienne LeBeau',
...
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Brother Voodoo', 'Jericho Drumm',
        ...
        9);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Robin III (Arkham)', 'Tim Drake',
...
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Iron Man', 'Tony Stark',
        ...
        15);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Storm (FOX)', 'Ororo Munroe',
        ...
        7);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Iron Man (Bleeding Edge)', 'Tony Stark',
        ...
        17);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Ragman (CW)', 'Rory Regan',
...
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Steel (1997)', 'John Irons',
...
VALUES (nextval('hibernate_sequence'), 'Ultra Magnus', 'Ultra Magnus',
        ...
        12);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Doctor Mid-Nite', 'Dr Charles Mcnider',
        ...
        7);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Robin II (Titans)', 'Jason Todd',
        ...
        5);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Hermione Granger', 'Hermione Granger',
        ...
        15);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Agamotto', 'Agamotto',
        'https://www.superherodb.com/pictures2/portraits/11/050/12519.jpg',
        ...
        63);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Vixen (CW)', 'Amaya Jiwe',
        'https://www.superherodb.com/pictures2/portraits/11/050/15410.jpg',
...
VALUES (nextval('hibernate_sequence'), 'Neji', 'Neji Hyuga',
        ...
        8);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Dr Manhattan', 'Jonathan Osterman',
...
VALUES (nextval('hibernate_sequence'), 'Mystogan', 'Jellal Fernandes',
        ...
        9);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Jesse Custer', 'Jesse Custer',
...
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Shadow King', 'Amahl Farouk',
...
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Constantine (CW)', 'John Constantine',
        ...
        11);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Cannonball', 'Samuel Zachery Guthrie',
...
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'James Bond', 'James Bond',
        ...
        5);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Bronze Tiger', 'Ben Turner',
        ...
        12);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Mimic', 'Calvin Montgomery Rankin',
...
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Captain Planet', '',
        ...
        18);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Maui', 'Maui',
        'https://www.superherodb.com/pictures2/portraits/11/050/11020.jpg',
        ...
        13);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Jubilee (Full Potential)', 'Jubilation Lee',
        ...
        7);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Archmage Antonidas', '',
        'https://www.superherodb.com/pictures2/portraits/11/050/14722.jpg',
        ...
        31);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Heat Wave (CW)', 'Mick Rory',
...
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Ruby', 'Ruby Rose',
        'https://www.superherodb.com/pictures2/portraits/11/050/11832.jpg',
        ...
        8);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Omni-Man', 'Nolan Grayson',
        ...
        26);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Spider-Ham', 'Peter Porker',
...
VALUES (nextval('hibernate_sequence'), 'Thori', 'Thori',
        ...
        10);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'The Thing (FOX)', 'Benn Grimm',
        'https://www.superherodb.com/pictures2/portraits/11/050/14291.jpg',
        'Agility, Durability, Invulnerability, Peak Human Condition', 6);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'John Constantine', 'John Constantine',
...
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Bilbo Baggins', 'Bilbo Baggins',
        ...
        10);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Aquagirl I', 'Tula',
...
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Husk', 'Paige Elisabeth Guthrie',
...
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Rogue (FOX)', 'Anna Marie',
...
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Warlock', 'Adam Warlock',
        ...
        11);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Spirit', 'Denny Colt',
        'https://www.superherodb.com/pictures2/portraits/11/050/797.jpg',
        ...
        7);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Iron Man (Infinity Gauntlet)', 'Tony Stark',
        ...
        62);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Wonder Woman', 'Diana Prince',
        ...
        17);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Spider-Man Noir', 'Peter Parker',
...
VALUES (nextval('hibernate_sequence'), 'Xeno Goku', 'Kakarot',
        ...
        23);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Black Knight III', 'Dane Whitman',
        'https://www.superherodb.com/pictures2/portraits/10/050/246.jpg', 'Weapon-based Powers', 6);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Luke Skywalker', 'Luke Skywalker',
        ...
        13);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Chamber', 'Jonothon Evan Starsmore',
        'https://www.superherodb.com/pictures2/portraits/10/050/44.jpg',
        'Energy Beams, Mind Blast, Psionic Powers, Telepathy', 5);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Darkman', 'Peyton Westlake',
...
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Captain America (Worthy) (MCU)', 'Steve Rogers',
        ...
        14);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Winter Soldier', 'Bucky Barnes',
...
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Power Girl', 'Kara Zor-L',
        ...
        18);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Daphne Powell', 'Daphne Powell',
        'https://www.superherodb.com/pictures2/portraits/10/050/1356.jpg', 'Telepathy', 4);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Alexstrasza', '',
        'https://www.superherodb.com/pictures2/portraits/11/050/11793.jpg',
        ...
        32);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Ronin', 'Clint Barton',
        'https://www.superherodb.com/pictures2/portraits/11/050/1202.jpg', '', 5);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Aquaman (Injustice)', 'Arthur Curry',
        ...
        12);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Falcon (MCU)', 'Sam Wilson',
        ...
        3);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Black Widow (MCU)', 'Natasha Romanov',
...
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Ganthet', 'Ganthet',
...
VALUES (nextval('hibernate_sequence'), 'Clea', 'Clea', 'https://www.superherodb.com/pictures2/portraits/10/050/45.jpg',
        ...
        32);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Kami Tenchi', 'Kami Tenchi',
...
VALUES (nextval('hibernate_sequence'), 'Finesse', 'Jeanne Foucault',
        ...
        6);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Thor (Ultimate)', 'Thor Odinson',
        ...
        32);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Battlestar', 'Lemar Hoskins',
...
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Robin', 'Dick Grayson',
        'https://www.superherodb.com/pictures2/portraits/10/050/850.jpg',
        'Intelligence, Marksmanship, Peak Human Condition, Weapon-based Powers, Weapons Master', 8);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Professor Dumbledore', 'Albus Dumbledore',
        ...
        30);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Johnny Cage', 'Johnny Cage',
        ...
        5);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Allan Quatermain', '',
        ...
        7);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Thor (Odin Force)', 'Thor Odinson',
        ...
        53);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Ash', 'Ash', 'https://www.superherodb.com/pictures2/portraits/11/050/16547.jpg',
        ...
        11);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'James Gordon', '',
        'https://www.superherodb.com/pictures2/portraits/11/050/714.jpg',
        'Danger Sense, Intelligence, Marksmanship, Weapon-based Powers, Weapons Master', 8);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Ambush Bug', 'Irwin Schwab',
        ...
        8);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Spider-Woman', 'Jessica Drew',
        ...
        6);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Feral', 'Maria Callasantos',
        ...
        4);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Black Lightning', 'Jefferson Pierce',
        ...
        5);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Man-Thing', 'Dr. Theodore Sallis',
        ...
        8);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Batgirl IV', 'Cassandra Cain',
...
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Banshee', 'Sean Cassidy',
...
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Beta Ray Bill', 'Beta Ray Bill (translation of his Korbinite name)',
        ...
        12);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Ino Yamanaka', '',
        ...
        7);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Lloyd', 'Lloyd Garmadon',
        ...
        10);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Pan', 'Son Pan',
        ...
        12);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Vigilante (CW)', 'Vincent Sobel',
        ...
        7);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Zero', 'DWN-∞ Zero',
        ...
        15);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Abin Sur', '',
        'https://www.superherodb.com/pictures2/portraits/10/050/1460.jpg', 'Lantern Power Ring', 9);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Dove (Titans)', 'Dawn Granger',
        ...
        6);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Bloodhawk', 'Lemuel Krug',
        ...
        6);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Cypher', 'Douglas Aaron Ramsey',
        ...
        12);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Iron Fist (MCU)', 'Danny Rand',
        ...
        4);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Raphael', '',
        'https://www.superherodb.com/pictures2/portraits/10/050/10328.jpg',
        'Accelerated Healing, Agility, Jump, Marksmanship, Natural Armor, Reflexes, Stamina, Stealth, Sub-Mariner, Weapons Master',
        6);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'The Question', 'Charles Victor Szasz ( Vic Sage)',
        ...
        10);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Caitlin Fairchild', 'Caitlin Fairchild',
        ...
        17);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Wonder Woman (Witching Hour)', 'Diana Prince',
        ...
        125);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Steve Montgomery', 'Steve Montgomery',
...
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Sister Grimm', 'Nico Minoru',
        ...
        17);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Jonah Hex', '',
...
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Spider-Woman III', 'Martha Franklin',
...
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Mazikeen', 'Mazikeen',
        ...
        108);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Patrick', 'Patrick Star',
        ...
        3);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Hellboy', 'Anung Un Rama',
        ...
        7);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Huntress (Injustice)', 'Helena Rosa Bertinelli',
        ...
        6);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Hawkgirl (CW)', 'Kendra Saunders',
...
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Iron Man (Model Prime) (MCU)', 'Tony Stark',
        ...
        26);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Johann Krauss', 'Johann Krauss',
        ...
        9);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Barb Wire', 'Barbara Kopetski',
        ...
        7);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Wonder Man', 'Simon Williams',
        ...
        13);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Kakashi Hatake', 'Kakashi Hatake',
        ...
        12);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Batgirl', 'Barbara Gordon',
        ...
        8);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Namora', 'Aquaria Nautica Neptunia',
        ...
        6);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Mera (New 52)', 'Mera',
        'https://www.superherodb.com/pictures2/portraits/11/050/16323.jpg',
        ...
        16);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Ant-Man II', 'Scott Lang',
        ...
        7);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'She-Ra', 'Princess Adora',
        ...
        16);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Kilowog', '', 'https://www.superherodb.com/pictures2/portraits/10/050/1428.jpg',
        'Accelerated Healing, Durability, Lantern Power Ring, Stamina, Super Strength, Telepathy, Underwater breathing',
        15);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Misty Knight (MCU)', 'Mercedes Kelly',
        ...
        7);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Silver Surfer (Worthy)', 'Norrin Radd',
        ...
        55);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Deathlok (MCU)', 'Michael Peterson',
...
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Hulk', 'Bruce Banner',
        'https://www.superherodb.com/pictures2/portraits/10/050/83.jpg',
        'Accelerated Healing, Agility, Cold Resistance, Durability, Heat Resistance, Invulnerability, Jump, Longevity, Mind Control Resistance, Radiation Absorption, Radiation Immunity, Reflexes, Self-Sustenance, Stamina, Super Breath, Super Speed, Super Strength, Toxin and Disease Resistance',
        16);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Huntress (CW)', 'Helena Bertinelli',
...
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Leech', '', 'https://www.superherodb.com/pictures2/portraits/10/050/834.jpg',
        'Power Nullifier', 3);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Namor', 'Namor McKenzie',
        ...
        11);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Ben 10', 'Benjamin Kirby Tennyson',
        ...
        31);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Nina Theroux', '',
        'https://www.superherodb.com/pictures2/portraits/10/050/1529.jpg', 'Mind Control, Psionic Powers', 6);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Green Lantern (2011)', 'Hal Jordan',
...
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Donatello', '',
        ...
        9);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Falcon', 'Sam Wilson',
        'https://www.superherodb.com/pictures2/portraits/10/050/56.jpg',
        'Animal Oriented Powers, Flight, Gliding, Telepathy', 4);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Hope Summers', 'Hope Summers',
...
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Firelord', 'Pyreus Kril',
...
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Cyrus Borg', 'Cyrus Borg',
        'https://www.superherodb.com/pictures2/portraits/11/050/16448.jpg',
        'Hacking, Intelligence, Marksmanship, Size Changing, Technopath/Cyberpath, Weapon Creation, Weapon-based Powers, Weapons Master',
        9);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Nick Fury', 'Nicholas Joseph Fury',
        'https://www.superherodb.com/pictures2/portraits/10/050/326.jpg', 'Longevity, Weapons Master', 6);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Heart Of The Monster Hulk', 'Bruce Banner',
        ...
        41);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Batgirl (Injustice)', 'Barbara Gordon',
        ...
        10);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Doctor Occult', 'Unknown',
        ...
        57);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Spider-Man (Black) (SONY)', 'Peter Benjamin Parker',
        ...
        9);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'DL Hawkins', 'Daniel Lawrence Hawkins',
        'https://www.superherodb.com/pictures2/portraits/10/050/943.jpg', 'Phasing', 5);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'War Machine (MCU)', 'James Rhodes',
        ...
        8);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), '3-D Man II', 'Delroy Garrett, Jr.',
        'https://www.superherodb.com/pictures2/portraits/11/050/10038.jpg', 'Super Speed, Super Strength', 6);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'He-Man', 'Prince Adam',
        ...
        13);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Qui-Gon Jinn', '',
        ...
        11);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Captain America (Worthy)', 'Steve Rogers',
        ...
        22);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Agent Zero', 'Christoph Nord',
...
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Invincible', 'Markus Sebastian Grayson',
        ...
        15);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Starfire', 'Koriandr',
...
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Mickey Mouse', 'Mickey Mouse',
        ...
        102);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Cyborg (DCEU)', 'VIctor Stone',
        ...
        5);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Question', 'Charles Victor Szasz',
        'https://www.superherodb.com/pictures2/portraits/10/050/760.jpg', 'Agility, Intelligence', 7);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Atom IV', 'Ryan Choi',
        'https://www.superherodb.com/pictures2/portraits/10/050/940.jpg', 'Intelligence, Size Changing', 9);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Dollar Bill', 'Bill Brady',
        ...
        5);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Midnighter', 'Unknown',
        ...
        9);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Aaron Cash', 'Aaron Cash',
        'https://www.superherodb.com/pictures2/portraits/11/050/11650.jpg', 'Weapon-based Powers, Weapons Master', 5);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Batman (Dark Knight)', 'Bruce Wayne',
...
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Son Goku (Toei Animation)', 'Kakarot',
        ...
        20);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Percy Jackson', 'Percy Jackson',
        ...
        16);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Samirah Al-Abbas', 'Samirah Al-Abbas',
        ...
        16);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'White Wolf (MCU)', 'James Buchanan Barnes',
        ...
        6);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Nomad (MCU)', 'Steve Rogers',
        ...
        8);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Captain Marvel II', 'Frederick Christopher Freeman',
...
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Watcher', 'Uatu',
        ...
        20);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Power Girl (New 52)', 'Kara Zor-L',
        ...
        15);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Katana (CW)', 'Tatsu Yamashiro',
        ...
        4);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'X-23', 'Laura Kinney',
        ...
        8);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Gotenks', 'Goten/Trunks',
        ...
        15);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Captain Atom', 'Nathaniel Adam',
        ...
        37);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Elongated Man', 'Ralph Dibny',
        'https://www.superherodb.com/pictures2/portraits/10/050/1381.jpg',
        'Agility, Durability, Elasticity, Shapeshifting, Size Changing', 8);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Superman Prime One-Million', 'Kal-El',
        ...
        56);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Franklin Storm', 'Dr. Franklin Storm',
        'https://www.superherodb.com/pictures2/portraits/10/050/170.jpg', '', 3);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Punisher', 'Frank Castle',
        ...
        6);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'White Canary (CW)', 'Sara Lance',
        ...
        11);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Ysera', 'The Dreamer',
        'https://www.superherodb.com/pictures2/portraits/11/050/14510.jpg',
        ...
        38);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Leo Fitz (MCU)', 'Leopold Fitz',
...
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Harry Osborn (SONY)', 'Harold Osborn',
        ...
        7);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Harbinger', 'Lyla Michaels',
        ...
        14);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Hiro Nakamura', 'Hiro Nakamura',
        'https://www.superherodb.com/pictures2/portraits/10/050/947.jpg',
        'Teleportation, Time Travel, Timeframe Control', 4);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Red Robin', 'Tim Drake',
...
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Aqualad II', 'Jackson Hyde',
        ...
        9);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Atom Smasher', 'Albert Julian Rothstein',
...
VALUES (nextval('hibernate_sequence'), 'Arceus', '', 'https://www.superherodb.com/pictures2/portraits/11/050/12299.jpg',
        ...
        91);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Oracle', 'Barbara Gordon',
        'https://www.superherodb.com/pictures2/portraits/10/050/749.jpg', 'Intelligence', 7);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Hooded Justice', 'Rolf Muller ( Possibly)',
        ...
        5);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Jean-Luc Picard', 'Jean-Luc Picard',
        'https://www.superherodb.com/pictures2/portraits/10/050/10567.jpg',
        'Intelligence, Marksmanship, Omnilingualism', 6);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Supergirl (Cosmic Adventures)', 'Kara Zor-El',
        ...
        56);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Aqualad', 'Garth',
        ...
        7);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Warpath', 'James Proudstar',
        ...
        5);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Mega Man', 'Rock Man',
        ...
        17);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Gwen Stacy', 'Gwendolyn Stacy',
        'https://www.superherodb.com/pictures2/portraits/11/050/173.jpg', 'Agility', 7);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Lightning Lad', 'Garth Ranzz',
        'https://www.superherodb.com/pictures2/portraits/10/050/1177.jpg', 'Electrokinesis', 4);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Amethyst', 'Amy Winston',
        'https://www.superherodb.com/pictures2/portraits/11/050/11112.jpg',
        ...
        44);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Yellowjacket', 'Hank Pym',
        'https://www.superherodb.com/pictures2/portraits/10/050/70.jpg', 'Animal Oriented Powers, Size Changing', 8);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Starman', 'Theodore Knight',
        ...
        12);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Boom-Boom', 'Tabitha Smith',
...
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Savage Dragon', 'Kurr',
...
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Odin (MCU)', 'Odin Borson',
        ...
        23);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Kai (The LEGO Ninjago Movie)', 'Kai',
        ...
        8);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Jemma Simmons (MCU)', 'Jemma Anne Simmons',
        'https://www.superherodb.com/pictures2/portraits/11/050/16406.jpg',
        'Endurance, Intelligence, Intuitive aptitude, Marksmanship', 9);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Flash (New 52)', 'Wally West',
        ...
        23);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Jolt', 'Helen Takahama',
        'https://www.superherodb.com/pictures2/portraits/10/050/1323.jpg',
        'Energy Blasts, Reflexes, Super Speed, Super Strength', 5);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Lady Blackhawk', 'Zinda Blake',
...
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Martian Manhunter (New 52)', 'Jonn Jonzz',
        ...
        22);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Devilman', 'Akira Fudo',
        ...
        125);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Ardina', 'Ardina',
        ...
        21);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Kirby', 'Kirby',
        'https://www.superherodb.com/pictures2/portraits/11/050/12641.jpg',
        ...
        32);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Micah Sanders', 'Micah Sanders',
        'https://www.superherodb.com/pictures2/portraits/10/050/951.jpg', 'Technopath/Cyberpath', 6);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Balrog', '', 'https://www.superherodb.com/pictures2/portraits/10/050/11037.jpg',
        ...
        5);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Professor Hulk', 'Bruce Banner',
        ...
        20);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Peggy Carter', 'Peggy Carter',
        'https://www.superherodb.com/pictures2/portraits/11/050/10401.jpg', 'Agility, Intelligence, Weapons Master', 7);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'She-Thing', 'Sharon Ventura',
        'https://www.superherodb.com/pictures2/portraits/10/050/461.jpg',
        'Cold Resistance, Durability, Heat Resistance, Super Strength', 7);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Silk', 'Cindy Moon',
...
VALUES (nextval('hibernate_sequence'), 'Iceman', 'Bobby Drake',
        ...
        10);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Synch', 'Everett Thomas',
        'https://www.superherodb.com/pictures2/portraits/10/050/175.jpg', 'Power Absorption', 8);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Batman (DC One Million)', '',
        ...
        10);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Hit-Girl', 'Mindy McCready',
...
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Chaos War Hercules', 'Hercules',
        ...
        56);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Negasonic Teenage Warhead (FOX', 'Ellie Phimister',
        'https://www.superherodb.com/pictures2/portraits/11/050/13982.jpg', 'Energy Beams, Force Fields, Jump', 5);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Data', 'Data',
        ...
        10);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'The Punisher (War Zone)', 'Frank Castle',
        'https://www.superherodb.com/pictures2/portraits/11/050/15963.jpg',
        'Agility, Dexterity, Durability, Endurance, Intelligence, Marksmanship, Peak Human Condition, Reflexes, Stamina, Stealth, Weapon-based Powers, Weapons Master',
        7);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Generator Rex', 'Rex Salazar',
        ...
        9);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Zombie Hulk (Power Cosmic)', 'Bruce Banner',
        ...
        121);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Hourman III', 'Matthew Tyler',
        ...
        25);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Mister Terrific (CW)', 'Curtis Holt',
...
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Resurrection Spawn', 'Al Simmons',
        ...
        25);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Ronin (MCU)', 'Clint Barton',
        ...
        7);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Tigra', 'Greer Grant Nelson',
...
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Sif', 'Sif', 'https://www.superherodb.com/pictures2/portraits/10/050/1533.jpg',
        ...
        12);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Flash III', 'Wally West',
        ...
        10);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Captain Metropolis', 'Nelson Gardner',
        ...
        6);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Doctor Strangefate', 'Charles Xavier',
        ...
        79);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Chp', 'Chp Of HIven',
        ...
        17);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Gamera', 'Gamera',
        'https://www.superherodb.com/pictures2/portraits/11/050/11413.jpg',
        ...
        23);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Wolverine II', 'Laura Kinney',
        ...
        8);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Batman (LEGO)', 'Bruce Wayne',
        ...
        4);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Sadie Kane', 'Sadie Kane',
        ...
        14);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Citizen Steel', 'Nathan Heywood',
...
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Firestorm', 'Ronald Raymond',
...
VALUES (nextval('hibernate_sequence'), 'Icon', 'Arnus',
        ...
        21);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Space Ghost', 'Thaddeus Bach',
        ...
        5);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Shang-Chi', 'Shang-Chi',
...
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Gary Bell', 'Gary Bell',
        'https://www.superherodb.com/pictures2/portraits/10/050/1526.jpg', 'Enhanced Senses, Intelligence', 6);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Black Canary (Injustice)', 'Dinah Laurel Lance',
        'https://www.superherodb.com/pictures2/portraits/11/050/16091.jpg',
        'Peak Human Condition, Sonic Scream, Stealth', 9);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Bananaman', 'Eric Wimp',
        'https://www.superherodb.com/pictures2/portraits/11/050/10557.jpg',
        'Flight, Invulnerability, Stamina, Super Speed, Super Strength', 3);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'The Boy', 'Number Five',
...
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Captain Britain', 'Brian Braddock',
        ...
        8);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'King Hyperion', 'Marcus Milton',
        ...
        17);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Trunks', 'Trunks',
        ...
        9);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Spoiler', 'Stephanie Brown',
...
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Superboy', 'Jonathan Kent',
        ...
        14);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Animal Man', 'Bernhard Baker',
...
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Quicksilver', 'Pietro Django Maximoff',
...
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Forge', '', 'https://www.superherodb.com/pictures2/portraits/10/050/62.jpg',
        'Intelligence, Magic', 5);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Magog', 'David Reid',
        'https://www.superherodb.com/pictures2/portraits/10/050/1324.jpg',
        'Durability, Energy Beams, Energy Blasts, Super Strength', 6);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Man-Wolf', 'John Jameson',
        ...
        6);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Future Warrior', 'Ace',
        ...
        32);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Starlord (Celestial Power MCU)', 'Peter Quill',
        ...
        15);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Martian Manhunter', 'Jonn Jonzz',
        ...
        26);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Flash', 'Jay Garrick',
        ...
        7);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Starling', 'Evelyn Crawford',
        'https://www.superherodb.com/pictures2/portraits/11/050/10105.jpg', 'Agility, Weapons Master', 6);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Batwoman V', 'Katherine Rebecca Kane',
...
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Fëanor', '', 'https://www.superherodb.com/pictures2/portraits/10/050/16369.jpg',
        ...
        18);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Starfire (Titans)', 'Koriandr',
        ...
        8);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Angel (FOX)', 'Warren Kenneth Worthington III',
        'https://www.superherodb.com/pictures2/portraits/11/050/14364.jpg', '', 10);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Zatanna', 'Zatanna Zatara',
        ...
        10);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Alex Fierro', 'Alex Fierro',
        ...
        10);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Word Girl', 'Becky Botsford',
        ...
        16);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Blade', 'Eric Brooks',
        ...
        6);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Howard The Duck', 'Howard',
        'https://www.superherodb.com/pictures2/portraits/11/050/82.jpg',
        ...
        10);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Harley Quinn (Injustice)', 'Harleen Quinzel',
        ...
        8);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Shriek', 'Frances Louise Barrison',
...
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Batman (Injustice)', 'Bruce Wayne',
        ...
        10);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Mister Fantastic (FOX)', 'Reed Richards',
...
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Crystal', 'Crystallia Amaquelin',
        ...
        6);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Hogun (MCU)', 'Hogun',
        'https://www.superherodb.com/pictures2/portraits/11/050/14374.jpg',
        ...
        5);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Green Lantern (New 52)', 'Alan Scott',
        ...
        10);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Darkstar', 'Laynia Petrovna',
...
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Luigi', 'Luigi Mario',
        'https://www.superherodb.com/pictures2/portraits/11/050/11141.jpg',
        ...
        13);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Naruto Uzumaki', '',
        ...
        15);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Sentry', 'Robert Reynolds',
        ...
        41);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Goku (Dragon Ball GT)', 'Kakarot',
        ...
        21);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Micro Lad', 'Gim Allon',
        'https://www.superherodb.com/pictures2/portraits/10/050/1181.jpg', 'Size Changing', 4);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Peter Griffin', 'Peter Griffin',
        'https://www.superherodb.com/pictures2/portraits/10/050/12623.jpg', 'Durability', 1);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Cyclops (FOX)', 'Scott Summers',
...
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Wildfire', 'Drake Burroughs',
        ...
        7);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Snake Eyes', 'Classified',
        ...
        6);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Pied Piper (CW)', 'Hartley Rathaway',
...
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Captain Rex', 'CT-7565',
        'https://www.superherodb.com/pictures2/portraits/11/050/10949.jpg',
        'Agility, Marksmanship, Peak Human Condition, Stamina, Weapons Master', 4);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Bionic Woman', 'Jamie Sommers',
...
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Hawkman (CW)', 'Carter Hall',
        'https://www.superherodb.com/pictures2/portraits/11/050/15404.jpg', 'Flight, Gliding, Super Strength', 5);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Doctor Strange', 'Stephen Strange',
        ...
        27);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Black Bat', 'Cassandra Cain',
        ...
        7);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Ray', 'Ray Terrill',
        ...
        10);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Havok (FOX)', 'Alexander Summers',
        'https://www.superherodb.com/pictures2/portraits/11/050/14361.jpg',
        'Energy Absorption, Energy Beams, Energy Blasts, Power Suit', 8);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Ezio Auditore da Firenze', 'Ezio Auditore da Firenze',
        ...
        8);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Ice', 'Tora Olafsdotter',
        'https://www.superherodb.com/pictures2/portraits/10/050/11166.jpg', 'Cryokinesis, Magic', 3);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Avatar Korra', 'Korra',
        ...
        8);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Katniss Everdeen', 'Katniss Everdeen',
...
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Colleen Wing', '',
        'https://www.superherodb.com/pictures2/portraits/11/050/298.jpg',
        'Intelligence, Weapon-based Powers, Weapons Master', 9);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Wild Dog (CW)', 'Rene Ramirez',
        ...
        5);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Captain Universe', 'Laura Kinney',
        ...
        31);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Thor Girl', 'Tarene',
        ...
        12);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Rubeus Hagrid', 'Rubeus Hagrid',
        ...
        12);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Optimus Prime', 'Orion Pax',
        ...
        28);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'James T. Kirk', 'James T. Kirk',
        'https://www.superherodb.com/pictures2/portraits/10/050/10565.jpg',
        'Intelligence, Marksmanship, Stamina, Stealth, Weapons Master', 6);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Bugs Bunny', 'Bugs Bunny',
        'https://www.superherodb.com/pictures2/portraits/11/050/12355.jpg',
        ...
        127);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Lara Croft', 'Lara Croft',
...
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Astérix', 'Astérix Le Gaulois',
...
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Aurora', 'Jeanne-Marie Beaubier',
        ...
        8);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Alex Danvers (CW)', 'Alex Danvers',
        'https://www.superherodb.com/pictures2/portraits/11/050/15557.jpg',
        'Agility, Intelligence, Weapon-based Powers, Weapons Master', 8);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Kismet', 'Ahti',
        'https://www.superherodb.com/pictures2/portraits/11/050/14322.jpg',
...
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Bishop', 'Lucas Bishop',
        ...
        9);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Jay', 'Jay Gordon',
        'https://www.superherodb.com/pictures2/portraits/11/050/16048.jpg',
        ...
        10);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Rip Hunter', 'Richard Hunter',
...
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Shazam', 'Billy Batson',
        'https://www.superherodb.com/pictures2/portraits/10/050/278.jpg',
        'Accelerated Healing, Agility, Clairvoyance, Energy Blasts, Enhanced Hearing, Enhanced Memory, Flight, Hypnokinesis, Immortality, Intelligence, Invulnerability, Longevity, Magic, Magic Resistance, Marksmanship, Omnilingualism, Reflexes, Self-Sustenance, Stamina, Super Breath, Super Speed, Super Strength, Teleportation',
        24);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Battle-Suit Batman (DCEU)', 'Bruce Wayne',
        ...
        10);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Bolobo', 'Bolobo',
        'https://www.superherodb.com/pictures2/portraits/11/050/16446.jpg',
        ...
        4);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Supergirl (Injustice)', 'Kara Zor-El',
        ...
        20);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Captain Universe (Spider-Man)', 'Peter Parker',
        ...
        21);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Bi-Beast', '',
...
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Rune King Thor', 'Thor Odinson',
        ...
        172);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Nick Fury (MCU)', 'Nicholas Fury',
        ...
        8);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Beast Boy', 'Garfield Mark Logan',
        ...
        6);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Quake', 'Daisy Johnson',
        ...
        9);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Dagger', 'Tandy Bowen',
        'https://www.superherodb.com/pictures2/portraits/10/050/51.jpg',
        'Energy Blasts, Light Control, Natural Weapons', 6);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Wonder Woman (New 52)', 'Diana Of Themyscira',
        ...
        16);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Starlord (MCU)', 'Peter Quill',
...
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Rescue', 'Pepper Potts',
        'https://www.superherodb.com/pictures2/portraits/11/050/11744.jpg',
        'Energy Beams, Energy Blasts, Flight, Intelligence, Weapon-based Powers', 10);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Whis', '', 'https://www.superherodb.com/pictures2/portraits/11/050/11725.jpg',
        ...
        29);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Judge Dredd', 'Joseph Dredd',
        ...
        7);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Sonya Blade', '',
        ...
        6);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Ego Hulk', 'Bruce Banner',
        'https://www.superherodb.com/pictures2/portraits/11/050/13078.jpg',
...
VALUES (nextval('hibernate_sequence'), 'Superman (DCEU)', 'Kal-El',
        ...
        15);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'The Batman Of Zur-En-Arrh', 'Tlano',
        ...
        10);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Medusa (MCU)', 'Medusalith Amaquelin',
...
VALUES (nextval('hibernate_sequence'), 'Swamp Thing (New 52)', 'Alec Holland',
        ...
        19);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Metron', 'Metron',
        'https://www.superherodb.com/pictures2/portraits/10/050/841.jpg',
        'Flight, Intelligence, Longevity, Teleportation, Time Travel', 11);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Dove II', 'Dawn Granger',
        'https://www.superherodb.com/pictures2/portraits/11/050/14437.jpg',
        ...
        4);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Aquaman', 'Orin',
        ...
        14);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Penance II', 'Robert Baldwin',
        'https://www.superherodb.com/pictures2/portraits/10/050/900.jpg', 'Energy Blasts', 7);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Robin III', 'Tim Drake',
...
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Ms Marvel II', 'Sharon Ventura',
        'https://www.superherodb.com/pictures2/portraits/10/050/897.jpg', 'Durability, Super Strength', 5);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Robin (Titans)', 'Dick Grayson',
...
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Soap', 'John MacTavish',
        'https://www.superherodb.com/pictures2/portraits/10/050/16316.jpg',
        'Peak Human Condition, Stealth, Weapons Master', 8);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Batwoman (CW)', 'Katherine Kane',
...
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Unworthy Thor', 'Thor Odinson',
        ...
        16);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'The Vampire Hunter', 'Simon Belmont',
        ...
        21);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Justice', 'Vance Astrovik',
...
VALUES (nextval('hibernate_sequence'), 'Citizen Steel (CW)', 'Nate Heywood',
        ...
        12);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Iron Fist', 'Danny Rand',
        ...
        8);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Gandalf', 'Olórin',
        'https://www.superherodb.com/pictures2/portraits/10/050/10858.jpg',
        'Animal Control, Energy Armor, Energy Blasts, Energy Manipulation, Fire Control, Fire Resistance, Intelligence, Light Control, Longevity, Magic, Mind Control, Resurrection, Stamina, Summoning, Telepathy, Weapon-based Powers, Weapons Master',
        14);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Mister Miracle', 'Scott Free',
        ...
        23);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Wasp III', 'Nadia Van Dyne',
        ...
        6);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Yang', 'Yang Xiao Long',
        ...
        15);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Orphan', 'Cassandra Cain',
        ...
        7);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Scathan', 'Scathan',
        'https://www.superherodb.com/pictures2/portraits/11/050/12488.jpg',
        ...
        64);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Spawn (Classic)', 'Al Simmons',
        ...
        42);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Shuri (MCU)', 'Shuri',
        'https://www.superherodb.com/pictures2/portraits/11/050/13971.jpg', 'Agility, Intelligence, Weapons Master', 8);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Arsenal', 'Roy William Harper, Jr.',
        'https://www.superherodb.com/pictures2/portraits/11/050/1014.jpg',
        'Agility, Marksmanship, Weapon-based Powers, Weapons Master', 5);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Bushido', 'Ryuko Orsono',
        'https://www.superherodb.com/pictures2/portraits/10/050/1541.jpg', 'Agility, Weapons Master', 3);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Northstar', 'Jean-Paul Beaubier',
...
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Rogue', 'Anna Marie',
        'https://www.superherodb.com/pictures2/portraits/10/050/831.jpg', 'Energy Absorption, Power Absorption', 8);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Doctor Strange (MCU)', 'Stephen Strange',
        ...
        26);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Will Solace', 'Will Solace',
        ...
        7);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Odin (Destroyer Armor)', 'Odin Borson',
        ...
        111);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Hellstorm', 'Daimon Hellstrom',
        ...
        18);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Impulse', 'Bartholomew Allen II',
        ...
        7);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Karnak (MCU)', 'Karnak Mander-Azur',
        ...
        9);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Kid Flash (CW)', 'Wally West',
        ...
        6);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Hellbat', 'Bruce Wayne',
...
VALUES (nextval('hibernate_sequence'), 'Hawk (Titans)', 'Hank Hall',
        ...
        4);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Zatanna (Smallville)', 'Zatanna Zatara',
        'https://www.superherodb.com/pictures2/portraits/11/050/14830.jpg',
        'Cryokinesis, Fire Control, Magic, Probability Manipulation, Telepathy, Terrakinesis, Water Control, Weather Control',
        12);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Adam Strange', 'Adam Strange',
        ...
        6);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Abe Sapien', 'Abraham Sapien',
        ...
        10);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Shadow Lass', 'Tasmia Mallor',
...
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Rama Kushna', 'Rama Kushna',
        ...
        142);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Stan Lee', 'Stan Lee',
        'https://www.superherodb.com/pictures2/portraits/11/050/10825.jpg', 'Magic', 5);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Superman (Pre-Crisis)', 'Kal-El',
        ...
        34);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'The Flash (CW)', 'Jay Garrick',
        ...
        20);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Captain Mar-vell', 'Genis-Vell',
        ...
        20);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Cyborg (Sonar Suit)', 'Victor Stone',
...
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Tempest', 'Angel Salvadore Bohusk',
        'https://www.superherodb.com/pictures2/portraits/10/050/1407.jpg',
        'Cryokinesis, Fire Control, Flight, Force Fields, Wind Control', 4);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Old Man Logan (FOX)', 'James Howlett',
        ...
        7);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Drax The Destroyer (MCU)', 'Drax',
        ...
        3);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Jin Kazama', 'Jin Kazama',
        'https://www.superherodb.com/pictures2/portraits/11/050/14400.jpg',
        'Agility, Chi Manipulation, Dexterity, Durability, Endurance, Jump, Reflexes, Stamina, Stealth, Super Speed, Super Strength',
        2);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Agent 13', 'Sharon Carter',
        ...
        9);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Professor X', 'Charles Francis Xavier',
        ...
        11);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Aayla Secura', 'Aayla Secura',
...
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Luke Cage', 'Luke Cage',
...
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Human Torch (FOX)', 'Jonathan Storm',
        ...
        7);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Lucifer Morningstar (Mortal)', 'Samael',
        ...
        75);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Shazam (DCEU)', 'Billy Batson',
        ...
        18);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Rey', '', 'https://www.superherodb.com/pictures2/portraits/10/050/10561.jpg',
        'Agility, Mind Control, Mind Control Resistance, Stamina, Telekinesis, The Force', 6);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Xerneas', 'Xerneas',
        ...
        22);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Flash IV', 'Bartholomew Allen II',
        ...
        10);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'AmanThul', '',
        ...
        36);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Shatterstar', 'Gaveedra Seven',
...
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Firestar', 'Angelica Jones',
...
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Plo Koon', 'Plo Koon',
        'https://www.superherodb.com/pictures2/portraits/11/050/10680.jpg',
        ...
        17);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Supergirl (New 52)', 'Kara Zor-El',
        ...
        12);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Goddess Of War', 'Diana Prince',
        ...
        63);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'X-Man', 'Nate Grey',
        ...
        13);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Drax the Destroyer', 'Arthur Sampson Douglas',
        ...
        7);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Beast (FOX)', 'Henry Philip McCoy',
...
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Tomar-Re', 'Tomar-Re',
        'https://www.superherodb.com/pictures2/portraits/11/050/12176.jpg',
        ...
        21);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Mister Terrific', 'Michael Holt',
...
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Stardust', '',
        ...
        22);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Captain America (EMH)', 'Steve Rogers',
        ...
        7);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Piccolo', 'Piccolo',
        ...
        33);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Demolition-Man', 'Dennis Dunphy',
...
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'James Bond (Craig)', 'James Bond',
...
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'The Alien Entity', '',
        'https://www.superherodb.com/pictures2/portraits/11/050/11883.jpg',
        ...
        141);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Altaïr Ibn-LaAhad', 'Altaïr Ibn-LaAhad',
        ...
        8);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Gogeta (Dragon Ball Super)', 'Goku/Vegeta',
        ...
        31);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Arthur Dayne', '',
        'https://www.superherodb.com/pictures2/portraits/11/050/14806.jpg',
        'Dexterity, Reflexes, Stamina, Weapons Master', 4);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Havok', 'Alexander Summers',
...
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Kid Flash', 'Wallace Rudolph West',
        'https://www.superherodb.com/pictures2/portraits/10/050/722.jpg', 'Accelerated Healing, Super Speed', 4);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Sun Wukong', '',
        'https://www.superherodb.com/pictures2/portraits/11/050/14224.jpg',
        ...
        117);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Mario', 'Mario',
        ...
        12);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Sam Winchester', 'Sam Winchester',
...
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Harrison Wells (CW)', 'Harrison Wells',
        'https://www.superherodb.com/pictures2/portraits/11/050/16411.jpg',
        'Agility, Intelligence, Intuitive aptitude, Marksmanship', 9);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Vision (MCU)', 'Vision',
        'https://www.superherodb.com/pictures2/portraits/11/050/12589.jpg',
...
VALUES (nextval('hibernate_sequence'), 'Emma Frost', 'Emma Frost',
        ...
        10);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Gaara', '', 'https://www.superherodb.com/pictures2/portraits/10/050/13710.jpg',
        ...
        13);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Superman (God Of Strength)', 'Kal-El',
        ...
        28);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Wonder Girl (Titans)', 'Donna Troy',
        ...
        15);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Captain Midnight', '',
        ...
        9);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Gravity', 'Greg Willis',
...
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Aquaman (New 52)', 'Arthur Curry',
        ...
        16);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Rocket Raccoon', 'Rocket Raccoon',
        ...
        4);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Hyperion', 'Mark Milton',
        ...
        16);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Wild Dog', 'Jack Wheeler',
        'https://www.superherodb.com/pictures2/portraits/11/050/10761.jpg',
        'Agility, Weapon-based Powers, Weapons Master', 6);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Heimdall', 'Rig-Heimdall',
        'https://www.superherodb.com/pictures2/portraits/11/050/10427.jpg',
        ...
        18);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Sage', 'Tessa',
...
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Highfather', 'Izaya',
        'https://www.superherodb.com/pictures2/portraits/11/050/10515.jpg',
        ...
        38);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), '2B', 'YoRHa No. 2 Type B',
        ...
        23);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Hot Rod', 'Hot Rod',
        'https://www.superherodb.com/pictures2/portraits/11/050/10876.jpg',
        ...
        6);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Kevin 11', 'Kevin Ethan Levin',
        ...
        5);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Maria Hill (MCU)', 'Maria Hill',
        'https://www.superherodb.com/pictures2/portraits/11/050/13884.jpg',
        'Agility, Intelligence, Marksmanship, Weapons Master', 7);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Magik', 'Illyana Rasputina',
        ...
        29);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Matt Garetty', 'Matt Garetty',
...
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Silver Surfer', 'Norrin Radd',
        ...
        47);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Aqualad (Young Justice)', 'Kaldurahm',
        ...
        4);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Hourman', 'Rex Tyler',
        'https://www.superherodb.com/pictures2/portraits/11/050/10079.jpg',
        ...
        8);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Guts', 'Guts The Black Swordsman',
...
VALUES (nextval('hibernate_sequence'), 'Mew', 'Mew', 'https://www.superherodb.com/pictures2/portraits/11/050/13442.jpg',
        ...
        35);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Azrael', 'Jean-Paul Valley',
        ...
        6);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Mogo', 'Mogo',
        ...
        37);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Nightwing (Arkham)', 'Dick Grayson',
        ...
        8);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'X-23 (FOX)', 'Laura Kinney',
...
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Storm', 'Ororo Munroe',
        ...
        8);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Silk Spectre II', 'Laurel Juspeczyk',
        ...
        5);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Iron Man (Galactus Buster)', 'Tony Stark',
        ...
        167);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Doc Samson', 'Leonard Samson',
        'https://www.superherodb.com/pictures2/portraits/10/050/54.jpg', 'Durability, Stamina, Super Strength', 8);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Offspring', 'Luke OBrian',
        ...
        9);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Yellowjacket II', 'Rita DeMara',
        'https://www.superherodb.com/pictures2/portraits/10/050/178.jpg', 'Energy Blasts, Flight, Size Changing', 4);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Flash (Injustice)', 'Barry Allen',
        ...
        12);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Phantom', 'Christopher Walker',
        ...
        6);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Goku (Ultra Instinct)', 'Kakarot',
        ...
        17);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Super-Soldier', 'Clark Kent',
        ...
        18);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Batgirl III', 'Helena Rosa Bertinelli',
...
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Iron Boy', 'Tony Stark',
        'https://www.superherodb.com/pictures2/portraits/11/050/10040.jpg',
        ...
        10);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Krypto', 'Krypto the Superdog',
        ...
        6);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Elektra', 'Elektra Natchios',
        ...
        6);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Jesse Quick (CW)', 'Jesse Wells',
        ...
        28);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Bruce Banner (Hulkbuster)', 'Bruce Banner',
...
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Negasonic Teenage Warhead', 'Ellie Phimister',
        'https://www.superherodb.com/pictures2/portraits/10/050/10556.jpg', 'Precognition, Telepathy', 4);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Android 18', 'Lazuli',
        ...
        12);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Reverse Flash (New 52)', 'Daniel West',
        ...
        16);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Iron Man (Hulkbuster Armor)', 'Tony Stark',
        ...
        18);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Sif (MCU)', 'Sif',
        'https://www.superherodb.com/pictures2/portraits/11/050/13902.jpg',
        ...
        14);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Raiden', 'Jack',
        'https://www.superherodb.com/pictures2/portraits/11/050/11518.jpg',
        ...
        18);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Jaina Proudmoore', '',
        'https://www.superherodb.com/pictures2/portraits/11/050/14506.jpg',
        ...
        35);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Selene', 'Selene',
        ...
        10);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Blue Beetle II', 'Theodore Kord',
        ...
        9);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Kid Flash II', 'Bartholomew Allen II',
        ...
        12);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Misty Knight', 'Mercedes Misty Knight',
        ...
        5);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Black Bolt', 'Blackagar Boltagon',
        ...
        11);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Star Sapphire', 'Carol Ferris',
        ...
        14);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Ariel', 'Ariel',
        'https://www.superherodb.com/pictures2/portraits/10/050/1348.jpg', 'Telepathy, Teleportation', 6);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Aloy', '', 'https://www.superherodb.com/pictures2/portraits/10/050/16984.jpg',
        'Agility, Enhanced Sight, Information Analysis, Marksmanship, Reflexes, Stamina, Stealth, Weapon Creation, Weapons Master',
        6);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'JJ Powell', 'JJ Powell',
        'https://www.superherodb.com/pictures2/portraits/10/050/1357.jpg', 'Intelligence', 7);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Star-Lord', 'Peter Jason Quill',
...
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Iron Man (MCU)', 'Tony Stark',
        ...
        13);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Cyborg', 'Victor Stone',
        ...
        8);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Peter Petrelli', 'Peter Petrelli',
        ...
        40);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Iron Man (God-Killer)', 'Tony Stark',
        ...
        53);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Tyrande Whisperwind', 'Priestess Of Elune',
        ...
        16);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Wasp', 'Janet Van Dyne',
        ...
        6);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Phantom Girl', 'Tinya Wazzo',
        'https://www.superherodb.com/pictures2/portraits/10/050/1184.jpg', 'Phasing', 4);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Ant-Man', 'Hank Pym',
        'https://www.superherodb.com/pictures2/portraits/10/050/857.jpg', 'Intelligence, Size Changing', 9);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Madame Xanadu', 'Nimue Inwudu',
        ...
        18);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Spongebob', 'Spongebob Squarepants',
        ...
        19);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Adam Monroe', '',
...
VALUES (nextval('hibernate_sequence'), 'Shaman', '', 'https://www.superherodb.com/pictures2/portraits/11/050/452.jpg',
        ...
        27);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Ryu', '', 'https://www.superherodb.com/pictures2/portraits/10/050/11029.jpg',
        ...
        7);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Nite Owl II', 'Daniel Dreiberg',
...
VALUES (nextval('hibernate_sequence'), 'Professor X (FOX)', 'Charles Francis Xavier',
        ...
        13);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Black Lightning (CW)', 'Jefferson Pierce',
        ...
        6);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Niki Sanders', 'Nicole Sanders',
        'https://www.superherodb.com/pictures2/portraits/10/050/952.jpg', 'Super Strength', 6);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Booster Gold', 'Michael Jon Carter',
        ...
        13);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Ancient One (MCU)', '',
        'https://www.superherodb.com/pictures2/portraits/11/050/12735.jpg',
        ...
        37);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Max Mercury', '',
        ...
        12);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Darwin (FOX)', 'Armando Muñoz',
        ...
        7);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Meltdown', 'Tabitha Smith',
        ...
        4);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Hawkeye II', 'Katherine Elizabeth Bishop',
...
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Hancock', 'John Hancock',
        ...
        12);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Superman (Worthy)', 'Kal-El',
        ...
        25);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Agent 13 (MCU)', 'Sharon Carter',
...
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Metamorpho', 'Rex Mason',
        ...
        14);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Green Lantern Batman', 'Bruce Wayne',
        ...
        33);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'A-Bomb', 'Richard Milhouse Jones',
...
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'She-Hulk', 'Jennifer Walters',
...
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Paul Blart', 'Paul Blart',
        'https://www.superherodb.com/pictures2/portraits/10/050/10479.jpg', '', 1);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'The Creeper', 'Jack Ryder',
        ...
        6);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Gypsy (CW)', 'Cynthia',
        'https://www.superherodb.com/pictures2/portraits/11/050/16420.jpg',
        ...
        6);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Revan', 'Unknown',
        'https://www.superherodb.com/pictures2/portraits/11/050/10694.jpg',
...
VALUES (nextval('hibernate_sequence'), 'Jiraiya', '',
        ...
        16);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Mbaku (MCU)', 'MBaku',
        'https://www.superherodb.com/pictures2/portraits/11/050/16672.jpg',
        'Agility, Durability, Marksmanship, Peak Human Condition, Reflexes, Stamina, Weapon-based Powers, Weapons Master',
        4);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Rocky Davis', 'Leslie Rocky Davis',
        ...
        5);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Machine Man', 'X-51, Aaron Stack',
...
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Robin V', 'Damian Wayne',
...
VALUES (nextval('hibernate_sequence'), 'Wolverine', 'Logan',
        ...
        8);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Superman (New 52)', 'Kal-El',
        ...
        14);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Future Warrior (Xenoverse 2)', 'Future Warrior',
        ...
        67);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Winter Soldier (MCU)', 'Bucky Barnes',
        'https://www.superherodb.com/pictures2/portraits/11/050/12728.jpg',
        'Accelerated Healing, Agility, Durability, Marksmanship, Reflexes, Stamina, Stealth, Super Speed, Super Strength, Weapons Master',
        3);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Superman (White Lantern)', 'Kal-El',
        ...
        88);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'John Wick', 'John Wick',
        ...
        4);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Guardian', 'James Olsen',
        'https://www.superherodb.com/pictures2/portraits/11/050/10760.jpg',
        ...
        6);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'All Might', 'Toshinori Yagi',
        ...
        11);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Solomon Kane', 'Solomon Kane',
        ...
        4);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Blue Beetle III', 'Jaime Reyes',
        ...
        8);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Black Panther (MCU)', 'TChalla',
        ...
        6);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Mon-El (CW)', 'Mon-El',
        'https://www.superherodb.com/pictures2/portraits/11/050/15418.jpg',
...
VALUES (nextval('hibernate_sequence'), 'Spawn', 'Al Simmons',
        ...
        19);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Wyatt Wingfoot', 'Wyatt Wingfoot',
        'https://www.superherodb.com/pictures2/portraits/10/050/164.jpg', '', 2);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Spyke', 'Evan Daniels',
...
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Gamora', 'Gamora Zen Whoberi Ben Titan',
        ...
        9);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Algalon The Observer', '',
        'https://www.superherodb.com/pictures2/portraits/11/050/14747.jpg',
        ...
        41);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Ant-Man II (MCU)', 'Scott Lang',
...
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Old King Phoenix Thor', 'Thor Odinson',
        ...
        189);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Ahsoka Tano', 'Ahsoka Tano',
        ...
        11);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Saint Walker', 'Bro’Dee Walker',
        ...
        32);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Plastic Man', 'Patrick OBrian',
        ...
        10);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Box IV', 'Madison Jeffries',
        'https://www.superherodb.com/pictures2/portraits/10/050/38.jpg', 'Telekinesis', 5);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Crimson Avenger', 'Lee Travis',
        ...
        7);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Yukio (FOX)', 'Yukio',
        'https://www.superherodb.com/pictures2/portraits/11/050/13888.jpg',
        'Agility, Dexterity, Endurance, Marksmanship, Precognition, Reflexes, Stamina, Stealth, Weapon-based Powers, Weapons Master',
        5);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'John Watson', 'John H. Watson',
        ...
        6);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Beyonder', '',
        ...
        55);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Mera', 'Mera',
        ...
        8);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Hashirama Senju', '',
        ...
        26);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Professor Hulk (MCU)', 'Bruce Banner',
        ...
        19);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Piccolo Daimao', 'Piccolo Daimoa',
        ...
        16);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Zatanna (Full Potential)', 'Zatanna Zatara',
        ...
        48);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Sentry (Stable)', 'Robert Reynolds',
        ...
        43);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Binary', 'Carol Danvers',
        ...
        20);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Longshot', '',
...
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Stephanie Powell', 'Stephanie Powell',
        'https://www.superherodb.com/pictures2/portraits/10/050/1355.jpg', 'Accelerated Healing, Super Speed', 6);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Bumblebee', 'Bumblebee',
...
VALUES (nextval('hibernate_sequence'), 'Ink', 'Eric Gitter',
        ...
        4);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'The Ray (CW)', 'Ray Terrill',
        ...
        11);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Brainiac 5 (CW)', 'Querl Dox',
        ...
        12);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'King Shark (CW)', 'Shay Lamden',
        ...
        13);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Dean Winchester', 'Dean Winchester',
...
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Flash II', 'Barry Allen',
        ...
        16);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'War Machine', 'James Rhodes',
        ...
        12);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Tien Shinhan', 'Tenshinhan',
        ...
        14);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Captain Nemo', 'Janni Dakkar',
        ...
        11);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Superman (Smallville)', 'Kal-El',
        ...
        16);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Domino (FOX)', 'Neena Thurman',
...
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Nightcrawler (FOX)', 'Kurt Wagner',
        ...
        4);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'The Rumor', 'Allison Hargreeves',
...
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Lar Gand', 'Mon-El',
        ...
        15);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Hulkling', 'Dorrek VIII',
        'https://www.superherodb.com/pictures2/portraits/11/050/10039.jpg',
        ...
        10);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Elongated Man (CW)', 'Ralph Dibny',
        ...
        12);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Scarlet Witch (Life Force)', 'Wanda Maximoff',
        ...
        118);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Violet Parr', 'Violet Parr',
...
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Gypsy', '', 'https://www.superherodb.com/pictures2/portraits/11/050/10110.jpg',
...
VALUES (nextval('hibernate_sequence'), 'Angel', 'Liam',
        ...
        9);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'The White Violin', 'Vanya Hargreeves',
        ...
        4);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Hulk (MCU)', 'Bruce Banner',
        ...
        15);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Echo Zane', 'Echo Zane',
        'https://www.superherodb.com/pictures2/portraits/11/050/16812.jpg',
        ...
        6);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Gohan', 'Son Gohan',
        'https://www.superherodb.com/pictures2/portraits/11/050/1205.jpg',
        ...
        18);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Crystal (MCU)', 'Crystalia Amaquelin',
        ...
        7);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Blue Beetle (Injustice)', 'Jaime Reyes',
        ...
        10);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Ron Weasley', 'Ronald Bilius Weasley',
...
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Fin Fang Foom', '',
        ...
        7);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Bill Cipher', 'Bill Cipher',
        ...
        100);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Daredevil (FOX)', 'Matt Murdock',
        ...
        8);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Rorschach', 'Walter Joseph Kovacs',
        'https://www.superherodb.com/pictures2/portraits/10/050/771.jpg',
        'Agility, Intelligence, Stamina, Stealth, Weapons Master', 6);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Ant-Man (MCU)', 'Hank Pym',
        ...
        10);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Wildcat', '',
        'https://www.superherodb.com/pictures2/portraits/11/050/10072.jpg',
        'Agility, Animal Attributes, Animal Oriented Powers, Dexterity, Weapons Master', 5);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Witchblade', 'Sara Pezzini',
        ...
        10);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Red Power Ranger', 'Jason Lee Scott',
        ...
        11);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Crimson Dynamo', 'Anton Vanko',
...
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Cosmo The Spacedog', 'Cosmo',
        ...
        9);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'White Witch', 'Wanda Zatara',
        ...
        42);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Nova', 'Samuel Alexander',
        'https://www.superherodb.com/pictures2/portraits/11/050/11792.jpg',
        ...
        15);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Scooby', 'Scooby-Doo',
        'https://www.superherodb.com/pictures2/portraits/11/050/12312.jpg',
        ...
        58);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Rainbow Dash', '',
        'https://www.superherodb.com/pictures2/portraits/11/050/11976.jpg',
        ...
        12);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Nozdormu', '',
        'https://www.superherodb.com/pictures2/portraits/11/050/14509.jpg',
        ...
        47);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Superman (2006)', 'Kal-El',
        ...
        17);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Nightcrawler', 'Kurt Wagner',
...
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Legion', 'David Haller',
        ...
        40);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Agent May (MCU)', 'Melinda May',
...
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Goku', 'Kakarot',
        ...
        23);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Supreme Kai Of Time', 'Chronoa',
        ...
        33);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Jack Frost', 'Jackson Overland Frost',
        ...
        9);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Popeye', 'Popeye',
        'https://www.superherodb.com/pictures2/portraits/11/050/11105.jpg',
        ...
        9);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Steve Trevor', 'Steve Trevor',
        'https://www.superherodb.com/pictures2/portraits/10/050/11201.jpg',
        'Agility, Weapon-based Powers, Weapons Master', 8);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Superman Cosmic Armor', 'Thought Robot',
        ...
        115);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Jonah Hex (CW)', 'Jonah Hex',
        ...
        6);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Miss Martian', 'Mgann Morzz',
        ...
        11);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Maya Herrera', 'Maya Herrera',
        'https://www.superherodb.com/pictures2/portraits/10/050/944.jpg',
        'Substance Secretion, Toxin and Disease Control', 5);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Rocket Raccoon (MCU)', 'Rocket Raccoon',
...
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Atom (CW)', 'Ray Palmer',
        'https://www.superherodb.com/pictures2/portraits/11/050/15401.jpg',
        ...
        13);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Liz Sherman', 'Elizabeth Anne Sherman',
...
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Spider-Man (Worthy)', 'Peter Parker',
        ...
        27);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Stargirl', 'Courtney Whitmore',
        ...
        9);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Superman (Donner)', 'Kal-El',
        ...
        20);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Arishem The Judge', 'Arishem',
        ...
        52);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Black Hulk', 'Tyrone Cash',
        ...
        14);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Spider-Gwen', 'Gwen Stacy',
        ...
        8);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Iceman (FOX)', 'Bobby Drake',
        ...
        6);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Bulma', 'Bulma',
        'https://www.superherodb.com/pictures2/portraits/11/050/1209.jpg',
        'Durability, Intelligence, Intuitive aptitude', 10);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Iron Man (Model Prime)', 'Tony Stark',
        ...
        22);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Rayman', 'Rayman',
        'https://www.superherodb.com/pictures2/portraits/11/050/10535.jpg',
        ...
        9);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Werewolf By Night', 'Jack Russell',
        ...
        13);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Starkiller', 'Galen Marek',
        ...
        14);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Alfred (DCEU)', 'Alfred Pennyworth',
        'https://www.superherodb.com/pictures2/portraits/11/050/14275.jpg',
        'Intelligence, Marksmanship, Weapons Master', 7);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Giant-Man', 'Hank Pym',
        'https://www.superherodb.com/pictures2/portraits/11/050/858.jpg',
        ...
        14);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Agent Coulson (MCU)', 'Phillip J. Coulson',
        ...
        8);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Cole MacGrath', 'Cole MacGrath',
        ...
        5);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Bruce Banner', 'Bruce Banner',
        'https://www.superherodb.com/pictures2/portraits/11/050/13715.jpg', 'Intelligence', 9);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Catwoman', 'Selina Kyle',
...
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Batman (GAM)', 'Kirk Langstrom',
        ...
        11);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Black Canary (CW)', 'Laurel Lance',
...
VALUES (nextval('hibernate_sequence'), 'Raven (Titans)', 'Rachel Roth',
        ...
        14);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Doc Green', 'Bruce Banner',
        ...
        24);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Shrek', 'Shrek',
        'https://www.superherodb.com/pictures2/portraits/11/050/11203.jpg',
        'Enhanced Senses, Super Speed, Super Strength', 7);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Splinter', 'Hamato Splinter Yoshi',
        ...
        8);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Ken', 'Ken Masters',
        ...
        5);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Hybrid', 'Scott Washington',
        ...
        9);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Luna', 'Luna Maximoff',
        'https://www.superherodb.com/pictures2/portraits/10/050/933.jpg', 'Psionic Powers', 5);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Vixen II (CW)', 'Mari',
        'https://www.superherodb.com/pictures2/portraits/11/050/15409.jpg',
        ...
        8);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Invisible Woman (FOX)', 'Susan Storm',
        ...
        13);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Tiamut', 'Tiamut',
        ...
        83);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Franklin Richards (Adult)', 'Franklin Richards',
        ...
        22);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Spock', 'Schn Tgai Spock',
        ...
        7);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'John Wraith', 'John Wraith',
        'https://www.superherodb.com/pictures2/portraits/11/050/1314.jpg', 'Longevity, Psionic Powers, Teleportation',
        8);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Spider-Man (MCU)', 'Peter Parker',
        ...
        7);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'El Diablo (DCEU)', 'Chato Santana',
...
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Batman (Arkham)', 'Bruce Wayne',
        ...
        12);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Meta Knight', 'Meta Knight',
        ...
        52);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Mister Fantastic', 'Reed Richards',
...
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Jar Jar Binks', 'Jar Jar Binks',
        'https://www.superherodb.com/pictures2/portraits/10/050/10563.jpg',
        'Agility, Enhanced Smell, Stealth, Sub-Mariner', 2);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Indestructible Hulk', 'Bruce Banner',
        ...
        17);
INSERT INTO hero(id, name, otherName, picture, powers, level)
VALUES (nextval('hibernate_sequence'), 'Robin (Teen Titans)', 'Dick Grayson',
